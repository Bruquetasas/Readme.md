...
##  Integrantes
* Agustina Candela Medina
* Julio Benjamin Avelino Bruquetas 
* Santino Reguera

## 📌 Descripción del Escenario
[Escriban aquí un resumen breve del caso o problema sobre el que van a trabajar].
...
* `/04_herramientas_CASE`: Análisis de herramientas CASE.
